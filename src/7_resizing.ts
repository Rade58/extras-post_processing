...
// to show you this dissable rgbShift pass, you can keep
// gammaCorrection pass
// and activate glitch pass

// Well we need to handle the resize
// It doesn't matter we already did this on window

// To see what is the problem lower the screen width
// refresh
// now try to increase the width

// You will see quality decreasing a lot, you will see
// huge rectangular pixels at the end
// so we gat problem when resizing from smaller to bigger screen size
// problem occurs since we are rendering in huge render targets

// This means just like we handled resize with renderer, we must do
// the same with effectComposer

// to fix this we will update effectComposer
// the same way we did in tick function where we apply
// .setSize and .setPixelRatio methods
